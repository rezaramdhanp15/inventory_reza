...
<body>
  ...
  <div class="mb-3">
    ...
    <input type="number" name="id_barang" value="<?php echo $result['id_barang']?>"
  ...
  <div class="mb-3">
    ...
    <input type="number" name="harga" value="<?php echo $result['harga']?>"
    class="form-control" class="form-number" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Stok</label>
    <input type="number" name="stok" value="<?php echo $result['stok']?>"
    class="form-control" class="form-number" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
